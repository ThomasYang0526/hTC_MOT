...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 10 18:59:02 2021
...
save_txt_dir = '/home/thomas_yang/ML/hTC_MOT/txt_file/pose_detection/prw.txt'
load_txt_dir = '/home/thomas_yang/ML/datasets/PRW/PRW/labels_with_ids/'
    ...
    with open(txt_fname, 'r') as f:
        ...
        for line_idx, line in enumerate(f.readlines()):
            ...
            if tid_curr == -1:
                ...
                label_str = '{:.2f} {:.2f} {:.2f} {:.2f} 0 {:d}'.format(xmin, ymin, xmax, ymax, tid_curr+517) #517 is MOT total IDs
